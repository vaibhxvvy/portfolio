 ...
 * All content lives here so UI components stay pure and presentation-only.
 */
...
/** Current operating status cards */
export const statusModules: StatusModule[] = [
  {
    label: 'Current Focus',
    icon: 'target',
...
/** Capability categories grouped by domain */
export const capabilities: CapabilityCategory[] = [
  {
    category: 'Artificial Intelligence',
    skills: ['LLMs', 'Prompt Engineering', 'RAG', 'AI Agents', 'LangChain', 'Fine-tuning'],
    color: '#7C3AED',
  },
  {
    category: 'Machine Learning',
    skills: ['Scikit-learn', 'TensorFlow', 'PyTorch', 'XGBoost', 'Model Deployment', 'MLOps'],
    color: '#06B6D4',
  },
  {
    category: 'Data Science',
    skills: ['Pandas', 'NumPy', 'Statistical Analysis', 'EDA', 'Data Visualization', 'Feature Engineering'],
    color: '#22C55E',
  },
  {
    category: 'Backend Engineering',
    skills: ['Python', 'FastAPI', 'SQL', 'REST APIs', 'Docker', 'Linux'],
    color: '#F59E0B',
  },
  {
    category: 'DevOps',
    skills: ['Git', 'Docker', 'CI/CD', 'Linux', 'Cloud Deployment', 'Vercel'],
    color: '#EC4899',
  },
  {
    category: 'Design & Frontend',
    skills: ['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'Figma', 'UI/UX'],
    color: '#8B5CF6',
  },
]
...
export const journey: JourneyEntry[] = [
  ...
  },
  {
    ...
    description: 'Began the journey into software development and data science.',
    type: 'milestone',
  },
]
...
/** Facade: legacy siteConfig export for quick migration */
